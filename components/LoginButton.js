  ...
  return (
    <div className="space-y-5">
      ...
      <button
        ...
        disabled={isLoading}
        className={`w-full flex items-center justify-center gap-3 px-6 py-4 sm:py-3 rounded-xl font-semibold text-base sm:text-lg transition-all shadow-lg active:scale-95 ${
          isLoading && provider === 'google'
            ? 'bg-gray-200 border-2 border-gray-300 text-gray-500 cursor-not-allowed'
            : 'bg-white border-2 border-gray-300 hover:border-gray-400 text-gray-700 hover:shadow-xl active:shadow-md'
        }`}
      >
        ...
        {isLoading && provider === 'google' ? (
          <>
            <div className="animate-spin rounded-full h-6 w-6 sm:h-5 sm:w-5 border-b-2 border-gray-600"></div>
      ...
      <button
        ...
        className={`w-full flex items-center justify-center gap-3 px-6 py-4 sm:py-3 rounded-xl font-semibold text-base sm:text-lg transition-all shadow-lg active:scale-95 ${
          isLoading && provider === 'line'
            ...
            : 'bg-[#06C755] hover:bg-[#05b34c] text-white hover:shadow-xl active:shadow-md'
        }`}
      >
        {isLoading && provider === 'line' ? (
          <>
